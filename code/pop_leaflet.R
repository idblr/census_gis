...
# Combine States
wus_zcta <- rbind(az_zcta_raw, ca_zcta_raw, co_zcta_raw, id_zcta_raw, ks_zcta_raw,
  mt_zcta_raw, ne_zcta_raw, nv_zcta_raw, nm_zcta_raw, nd_zcta_raw, ok_zcta_raw,
  or_zcta_raw, sd_zcta_raw, tx_zcta_raw, ut_zcta_raw, wa_zcta_raw, wy_zcta_raw)
...
true_centroids <- rgeos::gCentroid(wus_zcta_deduped, byid = TRUE)
str(true_centroids)
sp::plot(true_centroids, pch = 2) # plot
...
campgrounds <- rgdal::readOGR(dsn = "../data", layer = "Campgrounds") # edit dsn according to working directory
